...
exil = commands.Bot(command_prefix=prefix, self_bot=True, intents=intents)
...
required = 'https://exil.ct.ws/","https://discord.gg/vrupW9A78a'

exil.remove_command("help")
...
async def dmall(ctx, *, message: str = None):
    ...
    await asyncio.gather(*[send_message(member) for member in members if member != exil.user])
...
# Any suggestion, join the discord an create an suggestion: https://discord.gg/vrupW9A78a
